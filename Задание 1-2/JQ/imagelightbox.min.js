...
! function (n, t, e, i) {
    ...
    var o = function () {
        ...
        c = function (n) {
            if (u) return !0;
            if (!d || "undefined" == typeof n || "undefined" == typeof n.pointerType) return !1;
        ...
        var i = n.extend({
            ...
            v = function (t) {
                ...
                if (t = "undefined" == typeof t ? !1 : "left" == t ? 1 : -1, l.length) {
                    if (t !== !1 && (o.length < 2 || i.quitOnEnd === !0 && (-1 === t && 0 == o.index(f) || 1 === t && o.index(f) == o.length - 1))) return E(), !1;
                    var e = {
                        opacity: 0
                    };
                ...
                h = !0, i.onLoadStart !== !1 && i.onLoadStart(), setTimeout(function () {
                    l = n("<img " + i.selector + " />").attr("src", f.attr("href")).on("load", function () {
                        ...
                        if (l.css("opacity", 0), r) a(l, -100 * t + "px", 0), setTimeout(function () {
